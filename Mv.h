...
void cargar_mnemonicos(tvectormnemonico vectormnemonico[])
{
    ...
    strcpy(vectormnemonico[27].mnemonico, "STOP");
    vectormnemonico[27].codigo = 0x0F;
    vectormnemonico[27].ejecuta = STOP;
}